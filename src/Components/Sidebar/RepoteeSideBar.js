        ...
        >
          ...
          <ul className="pt-2">
            ...
            <Link to='evalution-setting' onClick={()=>handelAction('evalution-setting')}>
              <li
                className={active === 'evalution-setting' ? 'text-white text-sm flex items-center gap-x-4 cursor-pointer p-2 rounded-md mt-2 bg-indigo-500' : 'text-white text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:text-fuchsia-600 rounded-md mt-2'}
