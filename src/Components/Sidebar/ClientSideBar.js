...
const ClientSideBar = () => {
  ...
  return (
    <>
      <div className="flex mt-20 lg:mt-16">
        <div
        ...
        >
          ...
          <Link to='adminDashbord' onClick={() => handelAction('adminDashbord')}>
              <li
                className={active === 'adminDashbord' ? 'text-white text-xs  flex flex-col lg:flex-row items-center gap-x-4 cursor-pointer p-2 rounded-md mt-10 bg-indigo-500' : 'text-white text-sm  flex flex-col lg:flex-row items-center gap-x-4 cursor-pointer p-2 hover:text-fuchsia-600 rounded-md mt-2'}
              >
