...
const Role = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center bg-gradient-to-t from-indigo-900 via-indigo-600  to-indigo-500 ... h-screen">
            <div className="">
                <div className="ml-12 py-6 mt-20 ">
                    <h3 className="text-4xl font-medium text-white">Select Your role</h3>
                    <div className="w-24 h-2 bg-yellow-500 rounded-md mt-3"></div>
                </div>
                <div className="flex flex-col lg:flex-row justify-around gap-5 w-full mt-10 h-30">
