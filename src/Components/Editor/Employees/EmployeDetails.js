...
//     axios
//       .get(
//         `https://timesheetapplication.onrender.com/mydashboard/${employeeId.e_id}`
//       )
//       .then((res) => {
          ...
          {isError ? (
            ...
            <>
              <div className="flex flex-row lg:flex-col w-full lg:w-1/3">
                ...
                <div className="w-1/2 lg:w-10/12 h-80 lg:h-56 rounded-md bg-white ml-2 mr-2 lg:mr-0 lg:ml-12 mt-4 lg:mb-4 shadow-2xl">
              ...
              <div className="flex flex-col w-full lg:w-2/3">
                ...
                <div className="w-11/12 rounded-md bg-white mt-2 lg:mt-3 mr-0 lg:mr-12 ml-5 lg:ml-6 pb-3 shadow-2xl">
                  <div className="flex justify-between ml-2 mr-2 lg:ml-4 lg:mr-10 mt-1">
                    <h3 className="font-bold text-base lg:text-xl text-slate-800">
                      Allocated Task(All)
                    </h3>
    ...
    <span className="w-2/12 py-1 text-xs text-center font-normal">{task.consumedHours}</span>
                ...
                <div className="w-11/12 rounded-md bg-white mt-2 lg:mt-4 mr-0 lg:mr-12 ml-5 lg:ml-6 lg:pb-4 shadow-2xl">
                  ...
                  <div className="flex-flex-col">
                    ...
                    <div className="overflow-auto scrollbar-hide h-32">
