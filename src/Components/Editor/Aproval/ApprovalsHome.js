      ...
      {isProcessing ? (
        ...
        <>
          {isError ? (
            ...
            <>
              <div className="flex flex-col lg:flex lg:flex-row  gap-4 lg:gap-8 mt-5 mb-6 lg:mb-1  lg:overflow-visible">
                <div className="flex lg:gap-4 gap-7  items-center">
                  <span className="font-medium text-slate-600 text-base">
                    Year:
                  </span>
                  <div className="w-48">
                  <Select 
