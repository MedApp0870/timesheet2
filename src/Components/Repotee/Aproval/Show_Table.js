        ...
        <div className="flex justify-center items-start gap-2 mb-3">
                ...
                <div className="flex flex-col w-7/12 mt-2 ml-8">
                    <div className="flex justify-between w-full gap-6 ">
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.sun} readOnly={( status === 'submit' || status === 'approved' || status === 'rejected'  ) && true} onChange={handelSun}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.mon}  readOnly={( status === 'submit' ||  status === 'approved' || status === 'rejected' ) && true}  onChange={handelMon}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.tue}  readOnly={( status === 'submit' ||status === 'approved' || status === 'rejected' ) && true}  onChange={handelTue}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.wed}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelWed}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.thurs}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelThu}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.fri}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelFri}></input>
                            <input  className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md" value={weeklyHours.sat}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelSat}></input>
                    ...
                    <div className="flex justify-between w-full gap-6 mt-2">
                            <input placeholder="Note Here" className="w-1/4 py-4 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.sun}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelSunNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.mon} readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelMonNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.tue}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelTueNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.wed}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelWedNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.thurs}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelThuNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.fri}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelFriNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs mr-10" value={weeklyNotes.sat}  readOnly={(status === 'submit' || status === 'approved' || status === 'rejected' ) && true}  onChange={handelSatNotes}></input>
                    </div>
                </div>
            </div>
    )
